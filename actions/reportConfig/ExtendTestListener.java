...
import reportConfig.ExtendTestManager;
...
public class ExtendTestListener extends AbstractTest implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		ExtendTestManager.getTest().log(LogStatus.FAIL, "Test Failed", ExtendTestManager.getTest().addBase64ScreenShot(base64Screenshot));
	}
